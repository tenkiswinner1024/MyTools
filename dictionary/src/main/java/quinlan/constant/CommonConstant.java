...
public interface CommonConstant {
    ...
    /** XXF {@code 600 参数不正确} (HTTP/1.0 - RFC 1945) */
    public static final Integer SC_PARAMETERS_ERROR = 600;
    /** XXF {@code 600 参数不正确} (HTTP/1.0 - RFC 1945) */
    public static final Integer SC_PARAMETERS_MISSION = 601;
    /** XXF {@code 600 参数不正确} (HTTP/1.0 - RFC 1945) */
    public static final Integer SC_TIMSTAMP_ERROR = 602;
    /**访问权限认证未通过 510*/
